    ...
    <section className="bg-gradient-to-r from-indigo-200 via-blue-300 to-blue-200 dark:from-gray-900 dark:via-gray-800 dark:to-black text-gray-800 dark:text-gray-200 body-font mx-4 sm:mx-6 md:mx-12 pb-16">
      <div className="px-0 sm:px-5 py-2 mt-8">
        ...
        <div className="mt-8 pb-4 flex flex-col items-center justify-center">
          <h1 className="title-font text-center font-bold text-3xl sm:text-4xl text-gray-900 dark:text-gray-100 border-b-4 border-blue-500 dark:border-blue-400 pb-2">
            IEEE Young Professionals
          </h1>
        </div>

        {/* About Description */}
        <div className="text-justify text-base sm:text-lg text-gray-800 dark:text-gray-300 px-4 md:px-16 lg:px-24 leading-relaxed mb-12">
          <p className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 px-4 md:px-6 mb-16 text-center">
          ...
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 bg-white dark:bg-gray-700 border-4 border-orange-400 dark:border-orange-500 rounded-full mb-4 overflow-hidden">
              <img src="/yp wiki.webp" alt="Wiki" className="w-full h-full object-contain p-2 dark:opacity-90" />
            </div>
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">YP Leadership Wiki</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4 px-2">
            ...
            <a
              ...
              className="px-6 py-2 rounded-full border border-orange-500 dark:border-orange-400 text-orange-500 dark:text-orange-400 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-400 dark:hover:text-black transition text-sm font-semibold"
            >
              LEARN MORE
            </a>
          </div>
          ...
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 bg-white dark:bg-gray-700 border-4 border-orange-400 dark:border-orange-500 rounded-full mb-4 overflow-hidden">
              <img src="/yp directory.webp" alt="Directory" className="w-full h-full object-contain p-2 dark:opacity-90" />
            </div>
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">YP Volunteers Directory</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4 px-2">
          ...
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 bg-white dark:bg-gray-700 border-4 border-orange-400 dark:border-orange-500 rounded-full mb-4 overflow-hidden">
              <img src="/yp executive.webp" alt="Executive" className="w-full h-full object-contain p-2 dark:opacity-90" />
            </div>
            <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2">YP Executive Committee</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4 px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 md:px-6">
          <div className="rounded-full overflow-hidden shadow-md dark:shadow-gray-900/50 border border-gray-300 dark:border-gray-600 w-[80%] mx-auto aspect-square">
            <img
              src="/yp3.jpg"
              alt="YP Event 1"

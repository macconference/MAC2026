    ...
    />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-16 lg:px-24">
          ...
          <div className="bg-pink-50 rounded-xl p-6 border border-pink-200 shadow-md hover:shadow-lg transition">
            ...
            <a href="https://wie.ieee.org/about/governance/" className="text-blue-600 font-semibold hover:underline">Read More</a>
          </div>
          ...
          <div className="bg-pink-50 rounded-xl p-6 border border-pink-200 shadow-md hover:shadow-lg transition">
            ...
            <a href="https://wie.ieee.org/about/wie-committee/" className="text-blue-600 font-semibold hover:underline">Read More</a>
          </div>
          ...
          <div className="bg-pink-50 rounded-xl p-6 border border-pink-200 shadow-md hover:shadow-lg transition">
            ...
            <a href="https://wie.ieee.org/about/faqs/" className="text-blue-600 font-semibold hover:underline">Read More</a>
          </div>
          ...
          <div className="bg-pink-50 rounded-xl p-6 border border-pink-200 shadow-md hover:shadow-lg transition">
            ...
            <p className="text-gray-800 mb-3">
             In order to maximize the ability for the IEEE Women in Engineering (WIE) brand to effectively reach all audiences, we must ensure that all materials maintain a consistent “look” and “theme.”
            </p>
            <a href="https://wie.ieee.org/about/ieee-wie-brand/" className="text-blue-600 font-semibold hover:underline">Read More</a>
          </div>
        </div>
      </div>
    </section>

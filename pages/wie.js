    ...
    <section className="bg-gradient-to-r from-indigo-200 via-blue-300 to-blue-200 dark:from-gray-900 dark:via-gray-800 dark:to-black text-gray-800 dark:text-gray-200 body-font mx-4 sm:mx-6 md:mx-12 pb-16">
      <div className="px-0 sm:px-5 py-2 mt-8">
        ...
        <div className="mt-8 pb-4 flex flex-col items-center justify-center">
          <h1 className="title-font text-center font-bold text-3xl sm:text-4xl text-gray-900 dark:text-gray-100 border-b-4 border-pink-500 dark:border-pink-400 pb-2">
        ...
        <div className="flex justify-center mt-8 mb-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-pink-500 dark:text-pink-400 text-center">
            About IEEE WIE
          </h1>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 md:px-16 lg:px-24">
          {/* Card 1 */}
          <div className="bg-pink-50 dark:bg-gray-800 rounded-xl p-6 border border-pink-200 dark:border-gray-600 shadow-md dark:shadow-gray-900/50 hover:shadow-lg dark:hover:shadow-gray-900/70 transition">
            <h3 className="text-xl font-bold text-pink-700 dark:text-pink-400 mb-2">Governance</h3>
          ...
          {/* Card 2 */}
          <div className="bg-pink-50 dark:bg-gray-800 rounded-xl p-6 border border-pink-200 dark:border-gray-600 shadow-md dark:shadow-gray-900/50 hover:shadow-lg dark:hover:shadow-gray-900/70 transition">
            <h3 className="text-xl font-bold text-pink-700 dark:text-pink-400 mb-2">WIE Committee</h3>
            <p className="text-gray-800 dark:text-gray-300 mb-3">
              The IEEE Women in Engineering Committee (WIEC) is a committee of the IEEE Member and
              Geographic Activities (MGA) Board, reporting through the MGA Member Engagement and
          ...
          {/* Card 3 */}
          <div className="bg-pink-50 dark:bg-gray-800 rounded-xl p-6 border border-pink-200 dark:border-gray-600 shadow-md dark:shadow-gray-900/50 hover:shadow-lg dark:hover:shadow-gray-900/70 transition">
            <h3 className="text-xl font-bold text-pink-700 dark:text-pink-400 mb-2">FAQ&apos;s</h3>
            <p className="text-gray-800 dark:text-gray-300 mb-3">
          ...
          {/* Card 4 */}
          <div className="bg-pink-50 dark:bg-gray-800 rounded-xl p-6 border border-pink-200 dark:border-gray-600 shadow-md dark:shadow-gray-900/50 hover:shadow-lg dark:hover:shadow-gray-900/70 transition">
            <h3 className="text-xl font-bold text-pink-700 dark:text-pink-400 mb-2">IEEE WIE Brand</h3>
            <p className="text-gray-800 dark:text-gray-300 mb-3">

    ...
    <section className="text-gray-600 body-font mx-4 sm:mx-6 md:mx-12 pb-16">
      <div className="px-0 sm:px-5 py-2 mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center px-4 md:px-16 lg:px-24 my-10">
          ...
          <img src="/group-photo-ieee-sight-group.jpg" alt="IEEE SIGHT" className="w-full rounded-xl bg-white p-2" />
        </div>

        {/* IEEE SIGHT Groups Section */}
<div className="px-4 md:px-16 lg:px-24 mb-12 text-gray-100 text-base sm:text-lg leading-relaxed">
  ...
  <p>
    ...
    Student Branch.
        ...
        {/* Section Header */}
        <h2 className="text-center text-white text-2xl font-bold mt-12 mb-6">
